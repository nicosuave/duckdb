...
def test_interactive_history_up_arrow_executes_previous(shell, tmp_path):
    # Configure a simple output mode so asserting results is stable.
    (tmp_path / ".duckdbrc").write_text(".mode list\n.headers off\n", encoding="utf-8")
    (tmp_path / ".duckdb_history").write_text("select 42;\n", encoding="utf-8")
...
def test_interactive_history_ctrl_p_executes_previous(shell, tmp_path):
    (tmp_path / ".duckdbrc").write_text(".mode list\n.headers off\n", encoding="utf-8")
    (tmp_path / ".duckdb_history").write_text("select 42;\n", encoding="utf-8")
